...
def create_train_data(type_data='HGG'):
    ...
    if type_data == 'HGG':
        ...
        t1s = glob('mhafiles/BRATS2015_Training/HGG11/*/*T1*/*T1.*.mha')
    ...
    total3_train, gt_train = resize_data(t1_sum, gt_sum)
...
def create_test_data():    
    ...
    # BRATS 2015
    #flairs_test = glob(r'TestingFlair/HGG11_2/*pat*/*Flair*/*Flair*.mha')
    ...
    t1s_test = glob('TestingT1/HGG11_5/*pat*/*T1.*/*T1.*.mha')
    gts = glob('TestingT1/HGG11_5/*pat*/*OT*/*OT*.mha') 
    ...
    total3_test, gt_test = resize_data(t1_sum, gt_sum)
    # total3_test, gt_test = resize_data_full(flair_sum, t1c_sum, t2_sum, t1_sum, gt_sum)
    print(total3_test.shape)
    print(gt_test.shape)
        
    np.save('TestingT1/HGG11_5/imgs_test_unet_HN.npy', total3_test)
    np.save('TestingT1/HGG11_5/imgs_label_test_unet_HN.npy', gt_test)
...
def load_test_data():
    imgs_test = np.load('TestingT1/HGG11_5/imgs_test_unet_HN.npy')
    imgs_label_test = np.load('TestingT1/HGG11_5/imgs_label_test_unet_HN.npy')
...
def load_val_data():
    imgs_val = np.load('TestingT1/HGG11_5/imgs_test_unet_HN.npy')
    imgs_label_val = np.load('TestingT1/HGG11_5/imgs_label_test_unet_HN.npy')    
