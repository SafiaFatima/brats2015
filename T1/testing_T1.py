...
# ----------------------------------------------------------------------------
from T1_data_prep1 import load_test_data
...
def load_trained_agu_model():   
    ...
    json_file = open('NewUnetBceNormT1/cnn_BRATs_unet_new.json', 'r')
    loaded_model_json = json_file.read()
    json_file.close()
    
    loaded_model = model_from_json(loaded_model_json)
    # load weights into new model    
    loaded_model.load_weights("NewUnetBceNormT1/cnn_BRATs_unet_new.h5")
...
def show_2Dimg_3(img_1, img_2, patient_number, slice_number):
    ...
    #plt.imshow(img, zorder=0, extent=[0.5, 8.0, 1.0, 7.0])
    fig.savefig('/home/res-safia-fatima/T1/NewUnetBceNormT1/HGG11_5/'+'Patient'+str(patient_number)+'Slice'+str(slice_number)+'.png')   
...
def cvt2color_img(img_src,patient_number,slice_number):
    imgddd = mpimg.imread('/home/res-safia-fatima/T1/TestingT1/HGG11_5/threshold_patient_HGG11_5/'+'Patient'+str(patient_number)+'Slice'+str(slice_number)+'.png')
